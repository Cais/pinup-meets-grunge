				...
				while ( have_posts() ) {
					...
					<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
						...
						<div class="post-details">
							...
							if ( get_the_title() == "" ) { ?>
								<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e( 'Permanent Link to post ', 'pinup-meets-grunge' );
								the_id(); ?>"><?php the_time( get_option( 'date_format' ) ); ?></a>
							<?php } else {
						...
						<?php wp_link_pages( array(
							'before'         => '<p><strong>' . __( 'Pages: ', 'pinup-meets-grunge' ) . '</strong>',
							'after'          => '</p>',
