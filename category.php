...
<div id="main-blog">
  ...
  <div id="content">
    ...
    <div id="category-title">
      <?php if ( $paged < 2 ) { ?>
        <?php _e('First page of the', 'pinup-meets-grunge'); ?> <span id="category-name"><?php single_cat_title(); ?></span> <?php _e('archive.', 'pinup-meets-grunge'); ?>
      <?php } else { ?>
        <?php _e('Page', 'pinup-meets-grunge');?> <?php _e($paged, 'pinup-meets-grunge'); ?> <?php _e('of the', 'pinup-meets-grunge'); ?> <span id="category-name"><a href="<?php echo $category_link; ?>" title="<?php echo $curr_cat; ?>"><?php single_cat_title(); ?></a></span> <?php _e('archive.', 'pinup-meets-grunge'); ?>
      <?php } ?>
    </div> <!-- #category-title -->
    ...
    <?php else : ?>
      ...
      <h2><?php _e('Not Found', 'pinup-meets-grunge'); ?></h2>
    	<p><?php _e('Sorry, there are no posts in this category.', 'pinup-meets-grunge'); ?></p>
